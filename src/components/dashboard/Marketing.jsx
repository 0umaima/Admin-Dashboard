    ...
    <div
      ...
      >
        ...
        <div className="flex flex-row items-center gap-4 md:gap-6 lg:gap-3 xl:gap-6">
          ...
          <p className="text-gray-text-color text-sm lg:text-xs xl:text-sm">Acquisition</p>
          </div>
          ...
          <p className="text-gray-text-color text-sm lg:text-xs xl:text-sm">Purchase</p>
          </div>
          ...
          <p className="text-gray-text-color text-sm lg:text-xs xl:text-sm">Retention</p>
          </div>
        </div>
    </div>
  )
