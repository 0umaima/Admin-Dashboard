...
function Breadcrumbs() {
  ...
  return (
    <div className="h-11 border-b-2 border-light-gray px-2 md:px-5 lg:px-7 flex items-center gap-3 md:gap-5 font-DMmono">
      ...
      <div className="text-sm lg:text-lg font-light flex justify-center gap-2 md:gap-5 text-light-gray-2">
      ...
      {pathnames.map((pathname, index) => {
        ...
        return (
          <div
            key={routePath}
            className="text-sm lg:text-lg font-light flex justify-center gap-2 md:gap-5 text-light-gray-2"
          >
            <span>/</span>
            {isLast ? (
              <span>{pathname}</span>
